...
let ApiClientService = class ApiClientService extends service_base_1.ServiceBase {
    constructor(repository) {
        super(api_client_entity_1.ApiClient, repository);
        this.repository = repository;
    }
};
ApiClientService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_2.InjectRepository(api_client_entity_1.ApiClient)),
