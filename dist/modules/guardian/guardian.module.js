...
GuardianModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([guardian_entity_1.Guardian]), account_module_1.AccountModule],
        controllers: [guardian_controller_1.GuardianController],
        providers: [guardian_service_1.GuardianService],
        exports: [guardian_service_1.GuardianService],
    })
], GuardianModule);
