...
let ClientTypeService = class ClientTypeService extends service_base_1.ServiceBase {
    constructor(repository) {
        super(client_type_entity_1.ClientType, repository);
        this.repository = repository;
    }
};
ClientTypeService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_2.InjectRepository(client_type_entity_1.ClientType)),
