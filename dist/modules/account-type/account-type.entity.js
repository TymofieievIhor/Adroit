...
let AccountType = class AccountType extends entity_base_1.EntityBase {
};
__decorate([
    typeorm_1.Column({ nullable: false, unique: true }),
    __metadata("design:type", Number)
], AccountType.prototype, "value", void 0);
__decorate([
    typeorm_1.Column({ nullable: false }),
    class_validator_1.Length(1, 64),
    __metadata("design:type", String)
], AccountType.prototype, "text_value", void 0);
__decorate([
    typeorm_1.Column({ nullable: false }),
    class_validator_1.Length(1, 64),
    __metadata("design:type", String)
...
], AccountType.prototype, "display_in_user_interface", void 0);
AccountType = __decorate([
    typeorm_1.Entity({ name: 'account_type' })
], AccountType);
